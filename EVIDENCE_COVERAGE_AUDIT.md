...
| Project requirements | Role-tagged messages, versioned requirements, conflicts, scoped approvals, source ids, audit events, draft clauses over authored workflows, and a separate direct/paraphrase/negative stress set with retained number-word failures. | [Specification evaluation](projects/project-specification-copilot/EVAL.md) | Open-domain conversation understanding, independent or expert labels, uncontrolled natural language, professional specification authorship, or live-team usage. |
...
- The [engineering review log](ENGINEERING_REVIEW_LOG.md) records defects and corrective changes.
