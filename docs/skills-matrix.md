...
| Embodied-agent simulation | Construction Embodied Agent | Grid Route Planner, Telemetry Monitor | No foundation VLA, perception, physics, ROS, or hardware. |
...
| Testing and evaluation | Full verifier and focused selected-project suites | Project smoke tests | Local runs are the primary evidence. |
