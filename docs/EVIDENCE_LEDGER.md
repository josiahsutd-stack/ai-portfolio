...
| [Building Energy Regression Experiment](../projects/building-energy-ml-pipeline/README.md) | Fixed 135/45 split of 180 bundled synthetic building rows | Random-forest MAE 30.29 and R2 0.579 vs mean-baseline MAE 42.50; 45 synthetic holdout rows | [`energy_eval_summary.json`](../projects/building-energy-ml-pipeline/demo_outputs/energy_eval_summary.json) | `python projects/building-energy-ml-pipeline/evaluate_model.py` | Not calibrated energy simulation or professional performance analysis |
| [Robot Telemetry Safety Rule Monitor](../projects/site-robot-safety-monitor/README.md) | Deterministic rule execution over 36 bundled unlabeled synthetic telemetry rows | 26 rule events (19 high, 7 medium) from 36 synthetic rows; no labeled accuracy evaluation | [`safety_monitor_demo_summary.json`](../projects/site-robot-safety-monitor/demo_outputs/safety_monitor_demo_summary.json) | `python projects/site-robot-safety-monitor/generate_demo_report.py` | Not a certified safety system or physical robot validation |
