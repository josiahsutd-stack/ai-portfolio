...
AEC RAG is the sole flagship. The other selected projects are ranked by role relevance, not presented as equivalent production depth.

| Target role | Primary evidence | Supporting evidence | Important boundary |
| --- | --- | --- | --- |
| Applied AEC AI Engineer | AEC RAG, Massing Explorer | Specification Copilot, QS Workbench | Local prototypes without customer or professional sign-off evidence. |
| Embodied AI / Robotics Engineer | Construction Embodied Agent | Grid Route Planner, Telemetry Monitor | Behavior cloning in structured simulation; no perception, ROS, or hardware. |
...
| AEC Product Engineer | Specification Copilot, QS Workbench | AEC RAG, Massing Explorer | Synthetic workflow data and explicit human review boundaries. |
...
The most differentiated fit is junior or applied AI engineering for the built environment, computational design, or construction robotics. The repository does not claim senior production ownership.
