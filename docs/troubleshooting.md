...
```bash
streamlit run projects/agentic-research-ops-assistant/app.py --server.port 8502
```
...
```bash
python -m uvicorn mlops_model_serving_monitoring.api:app --app-dir projects/mlops-model-serving-monitoring/src --reload
```
