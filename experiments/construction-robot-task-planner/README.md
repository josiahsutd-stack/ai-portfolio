...
```bash
streamlit run experiments/construction-robot-task-planner/app.py
```
...
streamlit run experiments/construction-robot-task-planner/app.py
python -m uvicorn construction_robot_task_planner.api:app --app-dir experiments/construction-robot-task-planner/src --reload
```
