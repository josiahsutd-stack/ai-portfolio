...
from local_text_classification_lab import (  # noqa: E402
...
def main() -> None:
    ...
    model_output_dir = REPO_ROOT / ".artifacts" / "local-text-classification-lab"
    ...
    print(f"Wrote fitted text-classification artifacts to {PROJECT_ROOT / 'demo_outputs'}")
