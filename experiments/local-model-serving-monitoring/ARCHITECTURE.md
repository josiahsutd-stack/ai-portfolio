...
This project is a local model-serving and monitoring scaffold over synthetic churn data. It executes model training, artifact metadata, inference logging, and PSI-based monitoring without claiming production deployment.
...
| Artifact writer | `observability.py` | Saves a joblib model and JSON metadata to a local directory. |
