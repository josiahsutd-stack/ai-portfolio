...
st.set_page_config(page_title="Local Model Serving", page_icon="AI", layout="wide")
...
st.dataframe(list_prediction_logs(limit=10), width="stretch")
st.subheader("Recent drift history")
st.dataframe(list_drift_reports(limit=10), width="stretch")
