...
def default_artifact_dir() -> Path:
    return project_root() / ".artifacts" / "model_artifacts"


def default_db_path() -> Path:
    return default_artifact_dir() / "inference_log.sqlite"
...
def save_model_artifact(
    ...
    *,
    ...
    target = Path(artifact_dir) if artifact_dir else default_artifact_dir()
