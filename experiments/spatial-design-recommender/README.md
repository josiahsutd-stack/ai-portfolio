...
```bash
streamlit run experiments/spatial-design-recommender/app.py
```
...
streamlit run experiments/spatial-design-recommender/app.py
python -m uvicorn spatial_design_recommender.api:app --app-dir experiments/spatial-design-recommender/src --reload
```
