...
| [AI/AEC Job Description Match Baseline](ai-aec-job-fit-analyzer/README.md) | Transparent keyword matching between job text and a supplied skill profile. | Not a learned hiring model or evidence of suitability. |
...
| [Spatial Design Scoring Baseline](spatial-design-recommender/README.md) | Explicit weighted rules over synthetic layout attributes. | Not generative design, optimization, or validated architectural advice. |
