...
st.set_page_config(
    page_title="Building Energy Regression Experiment", page_icon="AI", layout="wide"
)
st.title("Building Energy Regression Experiment")
st.caption("Synthetic random-forest regression over generated building attributes.")
