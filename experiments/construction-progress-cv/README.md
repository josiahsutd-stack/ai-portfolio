...
```bash
streamlit run experiments/construction-progress-cv/app.py
```
...
streamlit run experiments/construction-progress-cv/app.py
python -m uvicorn construction_progress_cv.api:app --app-dir experiments/construction-progress-cv/src --reload
```
