...
```bash
python experiments/site-robot-safety-monitor/generate_demo_report.py
...
```bash
streamlit run experiments/site-robot-safety-monitor/app.py
python -m uvicorn site_robot_safety_monitor.api:app --app-dir experiments/site-robot-safety-monitor/src --reload
```
