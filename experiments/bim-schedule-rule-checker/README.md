...
```bash
streamlit run experiments/bim-schedule-rule-checker/app.py
```
...
streamlit run experiments/bim-schedule-rule-checker/app.py
python -m uvicorn bim_schedule_rule_checker.api:app --app-dir experiments/bim-schedule-rule-checker/src --reload
```
