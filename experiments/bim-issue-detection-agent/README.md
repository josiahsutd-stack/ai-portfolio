...
```bash
streamlit run experiments/bim-issue-detection-agent/app.py
```
...
streamlit run experiments/bim-issue-detection-agent/app.py
python -m uvicorn bim_issue_detection_agent.api:app --app-dir experiments/bim-issue-detection-agent/src --reload
```
