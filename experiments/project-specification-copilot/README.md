...
python experiments/project-specification-copilot/evaluate_specification.py
streamlit run experiments/project-specification-copilot/app.py
```

Optional local API:

```bash
python -m uvicorn project_specification_copilot.api:app --app-dir experiments/project-specification-copilot/src --reload
```
