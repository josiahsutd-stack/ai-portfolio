...
.PHONY: setup verify review sample-data test lint format smoke health claims commands profile brief visual-contract evidence provenance site visuals review-artifacts demo clean run-portfolio
