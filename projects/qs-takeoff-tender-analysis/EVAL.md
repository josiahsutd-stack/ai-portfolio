...
- 3 synthetic rectangular floor plans: a single room, two adjoining rooms, and an L-shaped three-room arrangement.
- 21 expected quantity lines calculated manually from fixture geometry.
- 7 synthetic SGD rates with explicit uncertainty and provenance fields.
- 3 synthetic anonymous tenders with 5 authored review exceptions.
