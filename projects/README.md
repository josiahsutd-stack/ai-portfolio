...
| Primary | [Construction Embodied Agent Simulator](vla-embodied-agent-simulator/README.md) | Controlled comparison of engineered-state random-forest and semantic-raster MLP imitation, 96 disjoint holdout scenarios, closed-loop evaluation, action filtering, and failure traces. | Fully observable simulator state only; no camera perception, foundation VLA, physics, ROS, or hardware. |
