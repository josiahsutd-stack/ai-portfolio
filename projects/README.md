...
| Primary | [Local Text Classification Lab](real-model-finetune-lab/README.md) | TF-IDF plus logistic-regression fitting, dummy baselines, fixed splits, held-out metrics, confusion matrix, and generated model binaries. | Classical supervised learning, not pretrained-model fine-tuning or a benchmark result. |
