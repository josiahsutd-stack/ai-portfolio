...
| Supporting | [Project Communication and Specification Assistant](project-specification-copilot/README.md) | Shared role-tagged chat, requirement lifecycle, conflict detection, scoped approval gates, SQLite audit events, source-linked draft clauses, and a 33-case language stress audit. | Manually labeled deterministic coverage checks; no authenticated authority, open-domain understanding, multi-user messaging service, or professional specification. |
