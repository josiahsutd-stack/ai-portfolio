...
- The 21 exact-chunk targets and 18 page targets were manually selected from the fixed local snapshot. They are not official clause annotations; exact-target Hit@1 is `0.810`, below document Hit@1 `0.952`.
