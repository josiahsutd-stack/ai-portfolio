...
`python projects/mlops-model-serving-monitoring/scripts/evaluate_model.py` writes model metrics, sample prediction logs, and a drift report to `demo_outputs/`.
