...
from mlops_model_serving_monitoring import (  # noqa: E402
    detect_drift,
    generate_churn_data,
...
def main() -> None:
    ...
    artifacts = save_model_artifact(model, metrics, registry_dir=output_dir / "model_registry")
    sample_payload = {
        "tenure_months": 12,
        "monthly_spend": 80,
        "support_tickets": 3,
    ...
    print(f"Wrote MLOps demo outputs to {output_dir}")
